...
export class SessionsTelemetryContribution extends Disposable implements IWorkbenchContribution {
	...
	private _getWorkspaceTopologyFields(workspace: ISessionWorkspace | undefined): WorkspaceTopologyFields {
		...
		const { isMultiRoot, workspaceFolderCount, nonGitFolderCount } = classifySessionWorkspaceTopology(folders.length, gitFolderCount);
		return { isMultiRoot, workspaceFolderCount, gitFolderCount, nonGitFolderCount };
	}
...
type SessionRequestSentClassification = {
	...
	workspaceFolderCount: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Number of workspace folders in the session (browser-projected metadata).' };
...
type SessionSummaryClassification = {
	...
	workspaceFolderCount: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Number of workspace folders in the session, captured the first time the session was observed in this client (browser-projected metadata).' };
